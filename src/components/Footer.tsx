...
const socials = [
  {
    href: "www.linkedin.com/in/rohan-singh-5bb59b197",
    label: "LinkedIn",
    Icon: Linkedin,
  },
  { href: "https://github.com/rohan-pckg", label: "GitHub", Icon: Github },
  { href: "mailto:rnsh.space@gmail.com", label: "Email", Icon: Mail },
];
